...
export const registerUser = (req, res) => {
	...
	const selectQ = 'SELECT * FROM users WHERE username = ?';

	return connectDB.query(selectQ, [username], (selectErr, data) => {
		...
		const insertQ = 'INSERT INTO users (`name`, `username`,`email`,`password`) VALUE (?)';
